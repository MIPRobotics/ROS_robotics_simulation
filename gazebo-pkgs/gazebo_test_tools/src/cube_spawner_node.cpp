...
int main(int argc, char** argv) {
    ...
    float height=0.03;   
    float mass=0.05;
    float dim=0.05; //for jaco test
    spawner.spawnCube(name,frame_id,x,y,z,0,0,0,1,length,width,height,mass); //Junior
    //spawner.spawnCube(name,frame_id,x,y,z,0,0,0,1,dim,dim,dim,mass); //for jaco test
    return 0;
}
